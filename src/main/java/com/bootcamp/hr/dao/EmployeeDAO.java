...
public class EmployeeDAO {
    ...
    private static final String INNER_JOIN_EMPLOYEE_DEPARTMENT = "SELECT e.employee_id, e.first_name, e.last_name, e.email, e.salary, e.job_id, e.department_id, d.department_name FROM employees e, departments d WHERE d.department_id = e.department_id";
    ...
    public List<Employee> findAll() {
        ...
        try {
            statement = databaseConnectionManager.getConnection().prepareStatement(INNER_JOIN_EMPLOYEE_DEPARTMENT);
